...
public:
	...
	Anim(sf::Vector2i l_frameSize, const std::string& l_name = "default", int l_numFrames = 1, int l_cols = 1, int l_rows = 1, sf::Vector2i l_startPos = { 0,0 }, float l_frameDelay = 0.1f, bool l_looping = true, bool l_isFlippedH = false, bool l_isFlippedV = false);
	
	Anim(const Anim&) = default;
	Anim& operator=(const Anim&) = default;
